...
const vector<vector<float>> DATA_TREE_STUMP_OBJECT = {
	...
	{TREE_HEIGHT, 0.f}, {TREE_STUMP_LENGTH, -TREE_HEIGHT, TREE_STUMP_LENGTH},
	{TREE_HEIGHT, 1.f}, {TREE_STUMP_LENGTH, TREE_HEIGHT, TREE_STUMP_LENGTH},
	{0.f, 1.f}, {-TREE_STUMP_LENGTH, TREE_HEIGHT, TREE_STUMP_LENGTH}, 
	{0.f, 0.f}, {-TREE_STUMP_LENGTH, -TREE_HEIGHT, -TREE_STUMP_LENGTH},
	{TREE_HEIGHT, 0.f}, {-TREE_STUMP_LENGTH, TREE_HEIGHT, -TREE_STUMP_LENGTH},
	{TREE_HEIGHT, 1.f}, {TREE_STUMP_LENGTH, TREE_HEIGHT, -TREE_STUMP_LENGTH},
	{0.f, 1.f}, {TREE_STUMP_LENGTH, -TREE_HEIGHT, -TREE_STUMP_LENGTH},
...
const vector<vector<float>> DATA_TREE_LEAVES_OBJECT = {
	...
	{TREE_TOP_HEIGHT, 0.f}, { TILE_LENGTH, TREE_HEIGHT, TILE_LENGTH },
	{TREE_TOP_HEIGHT, 1.f}, { TILE_LENGTH, TREE_TOP_HEIGHT, TILE_LENGTH },
	{0.f, 1.f}, { -TILE_LENGTH, TREE_TOP_HEIGHT, TILE_LENGTH },

	{0.f, 0.f}, { -TILE_LENGTH, TREE_HEIGHT, -TILE_LENGTH },
	{TREE_TOP_HEIGHT, 0.f}, { -TILE_LENGTH, TREE_TOP_HEIGHT, -TILE_LENGTH },
	{TREE_TOP_HEIGHT, 1.f}, { TILE_LENGTH, TREE_TOP_HEIGHT, -TILE_LENGTH },
	...
	{0.f, 0.f}, { -TILE_LENGTH, TREE_HEIGHT, -TILE_LENGTH },
	{TREE_TOP_HEIGHT, 0.f}, { TILE_LENGTH, TREE_HEIGHT, -TILE_LENGTH },
	{TREE_TOP_HEIGHT, 1.f}, { TILE_LENGTH, TREE_HEIGHT, TILE_LENGTH },
	{0.f, 1.f}, { -TILE_LENGTH, TREE_HEIGHT, TILE_LENGTH },
